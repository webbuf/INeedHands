...
namespace Assets.Scripts
{
    class Slicer
    {
        ...
        private static GameObject CreateMeshGameObject(GameObject originalObject)
        {
            ...
            string id = originalObject.GetComponent<IngredientInfo>().getID();
            ...
            meshGameObject.AddComponent<IngredientInfo>();

            meshGameObject.GetComponent<IngredientInfo>().setID(id);
        ...
        /// 
        //WHERE WE CAN ADD OUR INGREDIENTS INDEX SCRIPT
